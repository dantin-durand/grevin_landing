        ...
        <div className="flex flex-col -mt-10 text-white font-montserrat">
            ...
            <div className="bg-black pb-24">
                <div className="flex flex-col items-center justify-center">
                    <img className="mt-16 mb-10" src="/assets/logo/logo.svg" alt="Museum logo" style={{objectFit: 'cover' }}/>
                    <h3 className="text-md text-center">Les droits d'auteur de toutes les expositions sont détenus par le Musée Grevin</h3>
                </div>
            </div>
            <div className="bg-black pt-10 grid grid-rows-1 grid-cols-12" style={footerStatue}>
                <div className="row-start-1 col-start-2 col-end-7">
                    ...
                    <div className="text-sm font-medium">
                        <ul>
                            ...
                            <li className="my-2 hover:text-yellow">Toutes nos personnalités</li>
                ...
                <div className="row-start-1 col-start-7 col-end-12 text-right">
                    ...
                    <div className="text-sm font-medium">
                        <ul>
                            ...
                            <li className="my-2 hover:text-yellow">Groupes / CE / Collectivités</li>
                            ...
                            <li className="my-2 hover:text-yellow">Professionnels du tourisme</li>
                        </ul>
                    </div>
                </div>
                <div className="row-start-2 col-start-2 col-end-12 grid grid-rows-1 grid-cols-12">
                    <p className="col-start-1 col-end-3 flex items-center justify-start">Mentions légales</p>
                    <p className="col-start-3 col-end-4 flex items-center justify-center">CGV</p>
                    <p className="col-start-4 col-end-10 flex items-center justify-center">@Musée Grévin 2022</p>
