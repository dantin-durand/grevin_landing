    ...
    return (
        <div className="rounded-3xl bg-white  border-4 border-[#A0042D]" style={{height: 'fit-content'}}>
            <div className="flex flex-col justify-center items-center mb-6">
                <h4 className="text-center text-lg mt-4" dangerouslySetInnerHTML={{ __html: title }}></h4>
            ...
            <div className={`flex flex-col justify-center items-center mt-4 ${isHighlighted? "mb-20" : "mb-10"}`}>
                <h3 className="text-center font-dancingScript font-bold text-xl">{price}€/mois</h3>
